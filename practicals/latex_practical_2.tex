...
\usepackage {graphicx}
\graphicspath{ {LaTeX_images/} } % define the path of where the images are stored
...
%\addbibresource{/Users/Noel/Documents/Stat with Noel//all LaTeX files from BAUER/library.bib} % this line is to give the path of the database
...
\textbf{\underline{\textit{Keywords:}}} D. suzukii, GreenGel-Technology, Spinosad % see how you can modify the appearance of words in the text
...
\begin{figure}[ht!]
\centering
\includegraphics[width=8cm]{image0009.jpg} % there is no need to adjust the height as this is done automatically.
\end{figure}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=8cm]{image0023.jpg} 
...
% to the left
\begin{figure}[ht!]
\includegraphics[width=8cm]{V2a_m_0.jpg} % notice how the \centering is removed here to assume the default positioning
...
% to the right
\begin{figure}[ht!]
\includegraphics[width=8cm, right]{IMG0008.JPG} % notice how the centering is removed here to assume the default positioning
...
\begin{figure}[ht!]
	...
	\centering
	\includegraphics[width=0.9\linewidth, height=5cm]{IMG0009.JPG} 
	\caption{larval development of D. suzukii }
	\label{fig:subim1}
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
	\centering
	\includegraphics[width=0.9\linewidth, height=5cm, angle=270]{image0009.jpg}
...
\bibliography{/Users/user/Documents/Stat_with_Noel/all_LaTeXfiles_BAUER/library.bib}{} % you need to add the path to your own library
